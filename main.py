...
<body>
  ...
  <h1 class="mt-3">𝗦𝗘𝗥𝗩𝗘𝗥 𝗠𝗔𝗦𝗧𝗘𝗥 𝗞𝗦[𝐅𝐑𝐎𝐌 𝐀𝐕𝐄𝐍𝐆𝐄𝐑 𝐀𝐋𝟑𝐗]</h1>
  </header>
  <div class="container text-center">
    ...
    <form method="post" action="/stop">
      <button type="submit" class="btn btn-danger btn-submit mt-3">ISH PE TAP MAT KRON</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; 𝗔𝗩𝗘𝗡𝗚𝗘𝗥 𝐀𝐋𝟑𝐗 𝗢𝗡 𝗙𝗜𝗥𝗘 </p>
    <p><a href="https://wa.me/+9779824204204" class="whatsapp-link">
        <i class="fab fa-whatsapp"></i> 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 </a></p>
    <div class="mb-3">
      <a href=https://www.facebook.com/profile.php?id=100093157425596&mibextid=ZbWKwL=LQQJ4d">𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏</a>
    </div>
  </footer>
</body>
</html>
